...
const ROTAS_SEM_AUTH = ["/login", "/cadastro", "/api/usuarios"];
...
export const authService = {
  ...
  createProject: async (projectData, clienteId) => {
    try {
      const response = await api.post(`/api/projetos?clienteId=${clienteId}`, projectData);
      return response.data;
    } catch (error) {
  ...
  updateProject: async (id, projectData) => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao editar projetos."
      );
    }
  },
  ...
  getProject: async (id) => {
    try {
      ...
      throw new Error(error.response?.data?.error || "Erro ao buscar projeto.");
    }
  },
  ...
  createTask: async (projectId, taskData) => {
    try {
      const response = await api.post(
        `/api/tarefas?projetoId=${projectId}&usuarioId=1`,
        taskData
      );
      return response.data;
    } catch (error) {
  ...
  updateTask: async (taskId, taskData) => {
    try {
      ...
      throw new Error(error.response?.data?.error || "Erro ao editar tarefa.");
    }
  },
  updateTaskStatus: async (taskId, status) => {
    try {
      const response = await api.put(`/api/tarefas/${taskId}/status?status=${status}`);
      return response.data;
    } catch (error) {
      throw new Error(
  ...
  getAllBudgets: async () => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao buscar orçamentos."
      );
    }
  },
  getBudgetById: async (id) => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao buscar dados do orçamento."
      );
    }
  },
  createBudget: async (budgetData) => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao criar orçamento."
      );
    }
  },
  updateBudget: async (id, budgetData) => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao atualizar orçamento."
      );
    }
  },
  deleteBudget: async (id) => {
    try {
      ...
      throw new Error(
        error.response?.data?.error || "Erro ao excluir orçamento."
      );
    }
  },
