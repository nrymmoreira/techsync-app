...
export const LastContactDate = styled.div`
  display: flex;
  align-items: center;
  gap: 0.375rem;
  font-family: ${fonts.secondary};
...
export const ActionButton = styled.button`
  ...
  color: ${props => {
    const theme = getTheme(props.$isDarkMode);
    return props.$isDelete ? theme.colors.error : theme.colors.textSecondary;
  }};
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  &:hover {
    background: ${props => {
      const theme = getTheme(props.$isDarkMode);
      return props.$isDelete ? `${theme.colors.error}20` : theme.colors.surface;
    }};
    border-color: ${props => {
      const theme = getTheme(props.$isDarkMode);
      return props.$isDelete ? theme.colors.error : theme.colors.primary;
    }};
    color: ${props => {
      const theme = getTheme(props.$isDarkMode);
      return props.$isDelete ? theme.colors.error : theme.colors.primary;
