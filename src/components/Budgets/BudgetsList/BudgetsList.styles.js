...
export const BudgetsContainer = styled.main`
  min-height: 100vh;
  padding-top: 80px;
  background: ${props => {
...
export const BudgetsContent = styled.div`
  max-width: 1400px;
  margin: 0 auto;
  padding: 2rem;
...
export const BudgetsHeader = styled.div`
  margin-bottom: 2rem;
`;
...
export const BudgetsTable = styled.table`
  width: 100%;
  background: ${props => {
    const theme = getTheme(props.$isDarkMode);
    return theme.colors.surface;
...
export const BudgetRow = styled.tr`
  cursor: pointer;
  transition: all 0.3s ease;
  border-bottom: 1px solid ${props => {
    const theme = getTheme(props.$isDarkMode);
...
export const BudgetClient = styled.div`
  font-family: ${fonts.secondary};
  font-size: 0.9375rem;
  color: ${props => {
    const theme = getTheme(props.$isDarkMode);
